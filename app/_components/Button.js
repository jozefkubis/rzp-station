...
const buttonSizes = {
  ...
  printOrSave: "text-xs 2xl:text-base p-2 font-bold",
};
...
const buttonVariants = {
  ...
  printOrSave:
    "text-primary-500 border border-none hover:text-primary-700 hover:bg-gray-100 active:scale-95 disabled:bg-gray-400 disabled:cursor-not-allowed hover:cursor-pointer",
};
