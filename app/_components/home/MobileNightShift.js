export default function MobileNightShift({
  ...
  return (
    <div
      className="flex flex-col gap-3 rounded-2xl border border-indigo-200/70 bg-gradient-to-br from-white via-indigo-50 to-indigo-100 px-5 py-4 shadow-[0_4px_12px_rgba(0,0,0,0.06)] transition-all duration-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-indigo-200/60 active:scale-95 active:shadow-[0_2px_6px_rgba(0,0,0,0.05)]"
      tabIndex={0}
    >
      {/* Nadpis alebo dátum */}
      {label && (
