  ...
  return (
    <div className="aspect-square auto-rows-[1fr] p-2 md:hidden">
      <button
        ...
        className="group flex h-full w-full flex-col items-center justify-center gap-2 rounded-2xl border border-amber-200/70 bg-gradient-to-br from-white via-amber-50 to-amber-100 shadow-[0_4px_12px_rgba(0,0,0,0.06)] transition-all duration-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-amber-200/60 active:scale-95 active:shadow-[0_2px_6px_rgba(0,0,0,0.05)]"
      >
