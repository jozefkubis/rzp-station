...
export default async function Page({ searchParams }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 lg:grid lg:grid-cols-[4rem_1fr]">
      ...
      {/* <div className=""></div> */}
      {/* DASHBOARD GRID */}
      <main className="grid grid-cols-[9rem_9rem] items-center justify-center gap-2 overflow-y-auto px-8 pb-8 pt-6 md:grid-cols-2 md:items-end md:p-6 lg:gap-2 xl:gap-8">
