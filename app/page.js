...
export default async function Page({ searchParams }) {
  ...
  // MARK: RENDER .......................................................................................
  return (
    <div className="min-h-screen border-primary-400 bg-gray-50 lg:grid lg:grid-cols-[4rem_1fr] 4xl:border-r-2">
      {/* NAVBAR / ASIDE */}
      ...
      <main className="grid grid-cols-[9rem_9rem] items-center justify-center gap-2 overflow-y-auto px-8 pb-8 pt-6 md:grid-cols-2 md:items-end md:p-6 lg:gap-3">
        ...
        <RenderOnMdUp>
          <div className="col-span-2 grid grid-cols-2">
            ...
            <div className="flex items-end justify-start md:max-w-full lg:max-w-[80%]">
              <BirthdayCard profiles={profiles} />
            </div>
        ...
        <section className="col-span-2 hidden h-full md:grid md:grid-cols-2 md:gap-2 lg:gap-4">
          <ShiftCalendar
            label="Dnes"
